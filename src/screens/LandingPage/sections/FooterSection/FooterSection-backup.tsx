...
export const  return (
    <footer className="flex flex-col w-full items-start justify-center px-4 md:px-8 lg:px-20 3xl:px-24 4xl:px-32 py-0 relative bg-blue-gray900">
      ...
      <div className="w-full max-w-[2400px] mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 lg:gap-12 3xl:gap-16 4xl:gap-20 px-0 py-8 md:py-12 relative self-stretch w-full border-t border-b border-slate-700">{/* ...existing code... */}oterSection = (): JSX.Element => {
