...
export const AtoutsSection = (): JSX.Element => {
  ...
  const cards = [
    {
      ...
      description:
        "Vous pouvez résilier à tout moment votre abonnement mensuel. Votre investissement initial de 490€ est sans engagement.",
    },
    {
      image: "../keys.png",
      title: "Clé en main",
