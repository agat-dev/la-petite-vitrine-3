  ...
  return (
    <div>
      ...
      <FileUpload
        ...
        onFileChange={(files) => onFileChange('visualElements', files)}
      />
      <FileUpload
        label="Texts and Content"
        onFileChange={(files) => onFileChange('textsContent', files)}
      />
      <FileUpload
        label="Other Files"
        onFileChange={(files) => onFileChange('otherFiles', files)}
      />
      <div>
